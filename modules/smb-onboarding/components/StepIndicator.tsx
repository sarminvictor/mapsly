/**
 * Step indicator · server component (pure presentation).
 *
 * Shows "Step N of 4" + a horizontal pill row for the four step
 * labels. Past + current steps highlighted; future steps muted.
 * Mobile-first: pills wrap on narrow widths.
 *
