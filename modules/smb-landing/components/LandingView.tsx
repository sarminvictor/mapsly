...
function CtaPill({
  ...
  const base: CSSProperties = {
    ...
    textDecoration: "none",
    whiteSpace: "nowrap",
    boxShadow: "0 12px 30px color-mix(in srgb, var(--color-coral) 30%, transparent)",
  };
...
function boldValues(text: string): ReactNode[] {
  return text
    .split(
      /([~$]?\d[\d,.]*%?(?:\s+searches(?:\s+a\s+month|\s*\/\s*mo)?)?)/g,
    )
    .map((part, i) =>
      /\d/.test(part) ? (
    ...
    >
      ...
      >
        ...
        <div className="landing-hero-cards">
          ...
          >
            <p style={heroCardTitle}>Position</p>
            <p
              style={{
                margin: "4px 0 0",
                fontFamily: SERIF,
    ...
    >
      ...
      >
        <div style={{ marginTop: 30, maxWidth: 700 }}>
          <p style={EYEBROW}>This week in your market
          </p>
          <h2
            style={{
              margin: "20px 0 0",
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: 19, color: "var(--color-text-2)" }}>
            {c.valueSuffix?.includes("→")
              ? c.valueSuffix.split("→").flatMap((part, i) =>
                  i === 0
                    ? [part]
                    : [
                        <svg
                        ...
                        >
                          <path
                            d="M13.5 0C13.5228 0.0338352 15.7136 3.28234 17.5049 4.99512C19.0467 6.46931 21.762 7.87747 21.9854 7.99219H22V9.99219L21.5234 10.2451C20.6362 10.7299 18.7114 11.8435 17.5049 12.9971C15.711 14.7123 13.5166 17.9676 13.5 17.9922L12.0049 16.4824C12.0096 16.4767 14.3421 13.6501 16 11.9922C16.6246 11.3676 17.4153 10.6476 18.1582 9.99219H0V7.99219H18.1494C17.4089 7.33872 16.6222 6.62123 16 5.99902C14.3466 4.34559 12.0222 1.53073 12.0049 1.50977L13.5 0Z"
                            fill="#909BA2"
                          />
                        </svg>,
                        part,
