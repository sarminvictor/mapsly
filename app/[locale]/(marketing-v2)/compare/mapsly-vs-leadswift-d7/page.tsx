...
// WP6-7 · /compare/mapsly-vs-leadswift-d7 — static SEO comparison page in the
// agency voice. See mapsly-vs-apollo/page.tsx for the caching rationale.

const CANONICAL_ORIGIN = "https://mapsly.ai";
const SLUG = "mapsly-vs-leadswift-d7" as const;
...
export default function MapslyVsLeadSwiftD7Page() {
